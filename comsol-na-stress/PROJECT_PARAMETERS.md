...
| 负极颗粒排布 | 四颗粒在 `x/y/z` 三方向错层 | `derived` | 按用户提供参考图重建；中心坐标见下表 |
| 正极颗粒中心 | `x=L_an+L_sep+L_ca/2`; `y=W/2`; `z=H/2` | `derived` | 几何居中公式 |

负极颗粒中心使用相对尺寸参数，尺寸缩放时保持参考图的拓扑：

| 颗粒 | 半径 | 中心 `(x/L_an, y/W, z/H)` |
|---|---:|---:|
| `hc_1` | `Rp_neg_large` | `(0.300, 0.300, 0.478)` |
| `hc_2` | `Rp_neg_large` | `(0.700, 0.700, 0.522)` |
| `hc_3` | `Rp_neg_small` | `(0.244, 0.756, 0.244)` |
| `hc_4` | `Rp_neg_small` | `(0.756, 0.244, 0.756)` |
