...
public final class GeometryBuilder {
    public void build(Model model) {
        ...
        var geom = model.component(ComsolTagUtils.COMPONENT).geom(ComsolTagUtils.GEOMETRY);
        ...
        geom.create("particle_semicircle", "Circle");
        geom.feature("particle_semicircle").set("r", "Rp");
        geom.feature("particle_semicircle").set("angle", "180");
        geom.feature("particle_semicircle").set("rot", "-90");
        geom.feature("particle_semicircle").set("selresult", "on");
        geom.run();

        var selections = model.component(ComsolTagUtils.COMPONENT).selection();
        selections.create(ComsolTagUtils.PARTICLE_DOMAIN, "Union");
        ...
        selections.create("particle_all_boundaries", "Adjacent");
        ...
        selections.create(ComsolTagUtils.AXIS_BOUNDARY, "Box");
        ...
        selections.create(ComsolTagUtils.SURFACE_BOUNDARY, "Difference");
        ...
        selections.create(ComsolTagUtils.FIX_POINT, "Box");
